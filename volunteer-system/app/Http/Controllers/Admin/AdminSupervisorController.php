...
{
    /**
     * عرض قائمة بجميع المشرفين في النظام.
     */
    ...
    /**
     * عرض تفاصيل مشرف معين مع الفرق التي يشرف عليها.
     */
    ...
    /**
     * حذف حساب مشرف (سيتم حذف الفرق المرتبطة به أو نقلها حسب منطق العمل).
     */
    public function destroy(User $supervisor)
    {
        ...
        // ملاحظة: قد ترغب في التحقق إذا كان المشرف لديه فرق نشطة قبل الحذف
        $supervisor->delete();
